...
describe(
    ...
    () => {
        ...
        (
            "that given %s, attempting to calculate milliseconds throws a TypeError",
            (arg) => {
                expect(() => {
                    // @ts-ignore
        ...
        test.each(invalidList)
        (
            "that given %s, attempting to convert from milliseconds throws a TypeError",
            (arg) => {
                expect(() => {
                    // @ts-ignore
        ...
        (
            "that given $seconds seconds, inSeconds returns $milliseconds milliseconds",
        ...
        test(
            "that not given any seconds, inSeconds returns 1000 milliseconds",
            () => {
        ...
        test.each(secondsList)
        (
            "that given $milliseconds milliseconds, toSeconds returns $seconds seconds",
        ...
        test(
            "that not given any milliseconds, toSeconds returns 0 milliseconds",
            () => {
        ...
        (
            "that given $minutes minutes, inMinutes returns $milliseconds milliseconds",
        ...
        test(
            "that not given any minutes, inMinutes returns 60000 milliseconds",
            () => {
        ...
        test.each(minutesList)
        (
            "that given $milliseconds milliseconds, toMinutes returns $minutes minutes",
        ...
        test(
            "that not given any milliseconds, toMinutes returns 0 minutes",
            () => {
        ...
        test.each(hoursList)
        (
            "that given $hours hours, inHours returns $milliseconds milliseconds",
            ({ hours, milliseconds }) => {
        ...
        test(
            "that not given any hours, inHours returns 3.6e6 milliseconds",
            () => {
        ...
        test.each(hoursList)
        (
            "that given $milliseconds, toHours returns $hours hours",
            ({ milliseconds, hours }) => {
        ...
        test(
            "that not given any milliseconds, toHours returns 0 milliseconds",
            () => {
        ...
        test.each(daysList)
        (
            "that given $days days, inDays returns $milliseconds milliseconds",
            ({ days, milliseconds }) => {
        ...
        test(
            "that not given any days, inDays returns 8.64e10 milliseconds",
            () => {
        ...
        test.each(daysList)
        (
            "that given $milliseconds, toDays returns $days days",
            ({ milliseconds, days }) => {
        ...
        test(
            "that not given any milliseconds, toDays returns 0 days",
            () => {
        ...
        test.each(weeksList)
        (
            "that given $weeks weeks, inWeeks returns $milliseconds milliseconds",
            ({ weeks, milliseconds }) => {
        ...
        test(
            "that given no weeks, inWeeks returns 6.048e11 milliseconds",
            () => {
        ...
        test.each(weeksList)
        (
            "that given $milliseconds milliseconds, toWeeks returns $weeks weeks",
            ({ milliseconds, weeks }) => {
        ...
        test(
            "that given no milliseconds, toWeeks returns 0 weeks",
            () => {
        ...
        (
            "that given $months months, inMonths returns $milliseconds milliseconds",
            ({ months, milliseconds }) => {
        ...
        test(
            "that given no months, inMonths returns 2.628e9 milliseconds",
            () => {
        ...
        test.each(monthsList)
        (
            "that given $milliseconds milliseconds, toMonths returns $months months",
            ({ milliseconds, months }) => {
        ...
        test(
            "that given no milliseconds, toMonths returns 0 months",
            () => {
        ...
        test.each(yearsList)
        (
            "that given $years years, inYears returns $milliseconds milliseconds",
            ({ years, milliseconds }) => {
        ...
        test(
            "that given no years, inYears returns 3.154e10 milliseconds",
            () => {
        ...
        test.each(yearsList)
        (
            "that given $milliseconds milliseconds, toYears returns $years years",
            ({ milliseconds, years }) => {
        ...
        test(
            "that given no milliseconds, toYears returns 0 years",
            () => {
        ...
        test(
            "that given no milliseconds, sleep defaults to using ONE_THOUSAND",
            async () => {
                // Setup
                const timeoutSpy = jest.spyOn(
                    global,
                    "setTimeout"
                );
        ...
        (
            "that given a value of %s, sleep times out after $expectedResult milliseconds",
            async ({ arg, expectedResult }) => {
                // Setup
                const timeoutSpy = jest.spyOn(
                    global,
                    "setTimeout"
