 ...
 */
describe(
    "NumberUtil Unit Test Suite",
    () => {

        test(
            "that ZERO is set to 0",
            () => {
        ...
        test(
            "that ONE_HUNDRED is set to 100",
            () => {
        ...
        test(
            "that ONE_THOUSAND is set to 1000",
            () => {
        ...
        test(
            "that TEN_THOUSAND is set to 10000",
            () => {
        ...
        test.each([
            ...
            {
                arg: 100,
                error: "Cannot convert a number larger than 100 to a string; Must be a number between 0 and 99"
            },
            {
                arg: 1000,
                error: "Cannot convert a number larger than 100 to a string; Must be a number between 0 and 99"
        ...
        (
            "that given $arg, convertToTwoCharacterString throws $error",
            ({ arg, error }) => {
                expect(() => {
                    // @ts-ignore
        ...
        (
            "that given $arg, convertToTwoCharacterString returns $result",
            ({ arg, result }) => {
        ...
        (
            "that given $arg as the first argument, roundToNth throws $error",
            ({ arg, error }) => {
                expect(() => {
                    NumberUtil.roundToNth(
                        arg as any,
                        0
                    );
                })
        ...
        (
            "that given $arg as the second argument, roundToNth throws $error",
            ({ arg, error }) => {
                expect(() => {
                    NumberUtil.roundToNth(
                        0,
        ...
        (
            "that given $num and $decimals, roundToNth returns $result",
            ({ num, decimals, result }) => {
                expect(NumberUtil.roundToNth(
                    num,
                    decimals
                ))
                    .toBe(result);
        ...
        (
            "that given $arg, roundToTwo throws $error",
            ({ arg, error }) => {
                expect(() => {
                    // @ts-ignore
        ...
        (
            "that given %s, roundToTwo correctly rounds the number to the nearest tenth decimal place",
            (
                num,
                expectedResult
            ) => {
        ...
        (
            "that given %s, roundToTwo correctly rounds the number to 0",
            (arg) => {
        ...
        test(
            "that given NaN, roundToTwo correctly returns 0",
            () => {
        ...
        test(
            "that given Infinity, roundToTwo correctly returns Infinity",
            () => {
