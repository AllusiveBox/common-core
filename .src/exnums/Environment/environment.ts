...
export default class Environment extends EXnum {
	...
	public static getEnvironment(
		...
		return this.getEXnum(value, false) || Environment.UNKNOWN;
	}
	 ...
	 *
	 */
	public isDevelopment(): boolean { return this === Environment.DEVELOPMENT; }
	 ...
	 *
	 */
	public isLocal(): boolean { return this === Environment.LOCAL; }
	 ...
	 *
	 */
	public isProduction(): boolean { return this === Environment.PRODUCTION; }
	 ...
	 *
	 */
	public supportsDebug(): boolean { return Environment.SUPPORTS_DEBUG.includes(this); }
