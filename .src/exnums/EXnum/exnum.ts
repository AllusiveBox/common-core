...
export default abstract class EXnum {
	...
	public static getEXnum<T extends EXnum>(
		...
		if ((errorIfNotFound)
			...
			throw new EXnumDoesNotExist(value, this);
		}
	...
	public static getValue(
		...
		if ((errorIfNotFound)
			...
			throw new EXnumDoesNotExist(exnum, this);
		}
	 ...
	 *
	 */
	public static toString(): string { return this.TYPE }
	...
	protected constructor(
		...
		if (isNullOrUndefined(code)) {
			...
			throw new EXnumMissingRequiredValue("code", this);
		...
		if (isNullOrUndefined(type)) {
			throw new EXnumMissingRequiredValue("type", this);
	 ...
	 *
	 */
	public toString(): string { return `${this.type}:${String(this.code)}`}
	 ...
	 *
	 */
	get code(): symbol { return this.#code; }
